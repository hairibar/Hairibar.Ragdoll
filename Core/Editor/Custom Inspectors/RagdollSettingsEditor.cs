...
namespace Hairibar.Ragdoll.Editor
{
    ...
    internal class RagdollSettingsEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            NaughtyEditorGUI.DrawHeader("Ragdoll Profile");
            ...
            NaughtyEditorGUI.DrawHeader("Limit Parameters");
            DrawLimitProperties();

            NaughtyEditorGUI.DrawHeader("Joint Processing");
            DrawJointProcessingProperties();

            NaughtyEditorGUI.DrawHeader("Rigidbody Settings");
